////int A = 7;
////int B = 4;
//////int potentiometerA = A4;
////int potentiometerB = A5;
////
////void setup() {
////  pinMode(A, OUTPUT);
////  pinMode(B, OUTPUT);
//////  pinMode(potentiometerA, INPUT);
////  pinMode(potentiometerB, INPUT);
////  Serial.begin(9600);
////}
////
...
////
////void loop() {
////  Serial.println(analogRead(potentiometerB));
////  Serial.println(bitRead(analogRead(potentiometerB), 9));
////}
//
//int trans = 7;
//
